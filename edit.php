...
{
$id=$_POST['id'];
$name=mysqli_real_escape_string($db, $_POST['tenDanhMuc']);


mysqli_query($db,"UPDATE danhmuc SET tenDanhMuc='$name' WHERE idDanhMuc='$id'");
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM danhmuc WHERE idDanhMuc=".$_GET['id']);
